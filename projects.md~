...
*   <span class="ext-link"><span class="icon">CO2SUD : Variabilité des flux air-mer de CO2  dans l'hémisphère austral : rôle des modes de variabilité atmosphérique et de la mésoéchelle océanique (INSU/LEFE, 2010-2012, PI: J. Le Sommer and M. Gehlen)</span></span>  
    <span class="ext-link"><span class="icon">[](http://servforge.legi.grenoble-inp.fr/projects/wg-southern-cross)</span></span>
*   <span class="ext-link"><span class="icon">[SouthernCross](http://servforge.legi.grenoble-inp.fr/projects/wg-southern-cross) : Southern Ocean variability and Cross-scale interactions (ANR-JCJC, 2009-2012, PI: J. Le Sommer).</span></span>
